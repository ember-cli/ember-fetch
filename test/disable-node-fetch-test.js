...
describe('it builds', function() {
  ...
  before(function() {
    ...
    return app.create('disableNodeFetch')
  ...
  it('Verify build output files', function() {
    return app.runEmberCommand('build')
      .then(function() {
        ...
        expect(app.filePath('dist/package.json')).to.not.have.content.that.match(
          /ember-fetch\/fastboot-fetch.js/, 'fastboot-fetch.js should not be included into vendor path list for fastboot');
      });
  });
